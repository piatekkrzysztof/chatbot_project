...
PLANS = {
    BASIC: Plan(BASIC, "Basic", 99, 1_000, white_label=False),
    PRO: Plan(PRO, "Pro", 199, 5_000, white_label=True),
    ENTERPRISE: Plan(ENTERPRISE, "Enterprise", 399, 20_000, white_label=True),
}
