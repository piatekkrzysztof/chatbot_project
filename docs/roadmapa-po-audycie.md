...
| F24 | Część 1 przygotowana do przeglądu (15.09.2026): wszystkie kontrole CI backendu blokujące - ruff (próg 50 → 29), mypy z pluginem django-stubs (223 → 47, zapadka; dług rósł od audytu z 218), bandit (waga średnia i wysoka, wykluczone wszystkie testy), pip-audit (każda podatność); panel: eslint bez ostrzeżeń (4 → 0); test martwych odnośników w dokumentacji; README bez nieaktualnych ograniczeń | Przegląd i CI; **ochrona gałęzi `main` w obu repozytoriach - ustawienie po stronie właściciela** (wymagane kontrole CI przed scaleniem); dalej obniżanie długu mypy (47) i ruff (29) |
