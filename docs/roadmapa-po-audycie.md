...
| F20 | Częściowo: 2.0.11 ogranicza body/cookies/zmienne lokalne i argumenty zadań w Sentry; 2.5.0 (część 1): odczyty wynoszące dane i zdarzenia dostępu w dzienniku z osobą i firmą, Sentry bez zapytań i tokenów z adresu, log bez e-maila zaproszenia, inwentarz przepływów i retencji | Decyzje właściciela o okresach przechowywania (dziennik, zaproszenia, sesje), sprawdzenie retencji Rendera i Sentry, harmonogram usuwania po odbiorze F21 |
