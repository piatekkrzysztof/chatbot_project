...
| F20 | Częściowo: 2.0.11 ogranicza body/cookies/zmienne lokalne i argumenty zadań w Sentry; 2.5.0 (część 1): odczyty wynoszące dane i zdarzenia dostępu w dzienniku z osobą i firmą, Sentry bez zapytań i tokenów z adresu, log bez e-maila zaproszenia, inwentarz przepływów i retencji ; 2.10.0: `raport_retencji` - ile danych zniknęłoby przy każdym progu, z liczbami zgodnymi z tym, co zrobi usuwanie; nic nie kasuje | Decyzje właściciela o okresach przechowywania (dziennik, zaproszenia, sesje) - teraz na liczbach z raportu; sprawdzenie retencji Rendera i Sentry; harmonogram usuwania (F21 odebrane 17.09.2026, warunek zdjęty) |
