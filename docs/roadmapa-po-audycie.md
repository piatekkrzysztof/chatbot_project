...
| F16 | Część 1 przygotowana do przeglądu (2.3.0): pomiar liczby zapytań na wszystkich listach panelu (3 i 30 obiektów) wykrył N+1 w dokumentach (2 zapytania na dokument) i historii rozmów (1 na wpis) - naprawione, test pilnuje stałej liczby zapytań; historia rozmów i zapytania kontaktowe stronami (50, maks. 200); filtr ocen w historii ograniczony do rozmów firmy. [Opis](listy-i-zapytania.md) | Przegląd i CI części 1; część 2: limity list wiedzy (dokumenty, FAQ, źródła), publiczne FAQ widgetu, strumieniowy eksport CSV; część 3: pomiar opóźnień i SLO na obecnych zasobach, obciążenie sesji JWT, rozdzielenie limitu panelu od limitu czatu |
