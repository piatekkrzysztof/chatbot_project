...
| 5. Wiedza i cykl życia danych | F10, F17, F18, F19, F25 | Kompletny import, atomowa publikacja embeddingów i usuwanie pochodnych, poprawne CSV i feedback, wyszukiwanie FAQ i regresja RAG | F25: #56, #61, #62 scalone i odebrane pomiarem (2.0.21). F17: #57 (2.0.16). F10: #58, #59 (2.0.17-2.0.18). F19: #60 (2.0.19). Do wykonania: F18 - po odbiorze pełnego odtworzenia |
| 6. Płatności | F11; status płatności z F22 | Idempotencja Checkout/webhooków, identyfikatory i okresy Stripe, retry/uzgadnianie; UI potwierdza konkretny zakup | F11 część 1: #64 wdrożony (2.0.22), odbiór w trybie testowym Stripe zaliczony 14.09.2026. Część 2 przygotowana do przeglądu (2.1.0): zmiana planu w portalu Stripe na tej samej subskrypcji, potwierdzenie konkretnej sesji z uzgodnieniem stanu, zakup tylko przez właściciela, powiadomienie o nieudanej płatności. Do wykonania: przegląd, CI, wdrożenie i odbiór części 2 |
...
| F22 | Upload, formularze, reset i ustawienia bezpieczeństwa wdrożone w panelu #15/backendzie #53. Stan zakupu w F11 część 2 (2.1.0): strona sukcesu pyta o konkretną sesję, rozróżnia aktywny plan, płatność w toku, wygasłą sesję i cudzą albo nieistniejącą płatność; ostrzeżenie o nieudanej płatności na ekranie Subskrypcja | Odbiór ustawień i rzeczywistych e-maili; odbiór stanu zakupu z F11; onboarding i pozostałe stany panelu |
