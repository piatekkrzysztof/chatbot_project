...
| F16 | Część 1 scalona (#67, panel #19, 2.3.0): pomiar liczby zapytań na wszystkich listach panelu (3 i 30 obiektów) wykrył N+1 w dokumentach (2 zapytania na dokument) i historii rozmów (1 na wpis) - naprawione, test pilnuje stałej liczby zapytań; historia rozmów i zapytania kontaktowe stronami (50, maks. 200); filtr ocen w historii ograniczony do rozmów firmy. Część 2 przygotowana do przeglądu (2.4.0): dokumenty i FAQ stronami od najnowszych, publiczne FAQ widgetu najwyżej 100 wpisów, eksport CSV (API i panel administracyjny) strumieniem. [Opis](listy-i-zapytania.md) | Przegląd i CI części 2; część 3: pomiar opóźnień i SLO na obecnych zasobach, obciążenie sesji JWT, rozdzielenie limitu panelu od limitu czatu |
