...
| F21 | Kontrola kopii #41, dostępny PITR; 2.0.14: zaszyfrowany pełny format, próba odtworzenia bazy i plików na danych syntetycznych; 2.9.0: `kontrola_pelnej_kopii` (sama znajduje najnowszą kopię `.saas`, brak kopii to błąd, nie cisza), `kontrola_obecnosci_kopii` (bez klucza szyfrowania, do uruchomienia poza Renderem) i przebieg GitHub Actions jako niezależny monitor braku przebiegów; [protokół odbioru](odbior-f21.md) | Odbiór 17.09.2026: pierwsza pełna kopia produkcji, izolowane odtworzenie na PG16 w 2,49 s, dane i pliki wróciły w komplecie, RTO danych ~10 min, RPO zmierzone 5 dni 15 h ([wynik](odbior-f21.md#wynik-odbioru---17092026)). Otwarte: alarmy i harmonogram - właściciel zdecydował 17.09.2026 o rezygnacji z płatnego crona, więc RPO zostaje nieokreślone, a monitor braku przebiegów czeka na wybór częstotliwości kopii. RTO produkcji niezmierzone |
